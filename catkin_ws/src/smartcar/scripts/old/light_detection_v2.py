...
class trafficLightDetector:
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            circles_red=cv2.HoughCircles(r_gray2,cv2.HOUGH_GRADIENT,1,600,param1=255,param2=30,minRadius=50,maxRadius=200)
            circles_green=cv2.HoughCircles(g_gray2,cv2.HOUGH_GRADIENT,1,600,param1=255,param2=30,minRadius=50,maxRadius=200)
            cv2.imshow('red',r_gray2)
            cv2.waitKey(100)
            print(circles_green)
            print(circles_red)
