...
if("TRUE" STREQUAL "TRUE")
  set(uvc_camera_SOURCE_PREFIX /home/smartcar/catkin_ws/src/uvc_camera)
  set(uvc_camera_DEVEL_PREFIX /home/smartcar/catkin_ws/devel)
  ...
  set(uvc_camera_INSTALL_PREFIX /home/smartcar/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/uvc_camera " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Ken Tossell <ken@tossell.net>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/smartcar/catkin_ws/src/uvc_camera/${idir}'.  ${_report}")
    endif()
