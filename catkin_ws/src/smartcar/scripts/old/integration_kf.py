...
#starter = True for not detect the green light
starter = False
#lidarLaunch = False for ignore the lidar
lidarLaunch = False
        ...
        while not rospy.is_shutdown():
            ...
            if ret == True:
                ...
                if(True):
                    ...
                    frontDistance = np.argsort(pixelY)[int(len(pixelY)/2)]
                    ...
                    aP[0] = predictedCoords[0][0]
                    aP[1] = predictedCoords[1][0]
                    print 'after'
                    print (aP[0],aP[1])
